...
class SectionMasterApi {
  ...
  static const String sectionMasterApiUrl =
      'https://fudo.magnexsolutions.com/api/v1_5/sectionmaster/940T0003/002';

  final http.Client _client;

  Future<SectionMasterSyncResult> syncSectionMaster({
    String apiUrl = SectionMasterApi.sectionMasterApiUrl,
